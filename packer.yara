...
rule JCAlg1 : Jeremy Collake
{
	...
	strings: 
		...
		$a2 = { BA 00 00 00 80 C7 44 24 14 08 00 00 00 43 8D A4 24 00 00 00 00 8B FF 03 D2 75 08 8B 16 83 C6 04 F9 13 D2 73 2C 8B 4C 24 10 33 C0 8D A4 24 00 00 00 00 05 00 00 00 00 03 D2 75 08 8B 16 83 C6 04 F9 13 D2 13 C0 49 75 EF 02 44 24 0C 88 07 47 EB C6 03 D2 75 08 8B 16 83 C6 04 F9 13 D2 0F 82 6E 01 00 00 03 D2 75 08 8B 16 83 C6 04 F9 13 D2 0F 83 DC 00 00 00 B9 04 00 00 00 33 C0 8D A4 24 00 00 00 00 8D 64 24 00 03 D2 75 08 8B 16 83 C6 04 F9 13 D2 13 C0 49 75 EF 48 74 B1 0F 89 EF 01 00 00 03 D2 75 08 8B 16 83 C6 04 F9 13 D2 73 42 BD 00 01 00 00 B9 08 00 00 00 33 C0 8D A4 24 00 00 00 00 05 00 00 00 00 03 D2 75 08 8B 16 83 C6 04 F9 13 D2 13 C0 49 75 EF 88 07 47 4D 75 D6 03 D2 75 08 8B 16 83 C6 04 F9 13 D2 72 C3 E9 26 FF FF FF B9 01 00 00 00 33 C0 8D A4 24 00 00 00 00 8D A4 24 00 00 00 00 90 03 D2 75 08 }
	condition:
		any of ($a*)
}
...
rule LZMA
{
	...
	strings: 
		...
		//x64
		$a4 = { 41 57 48 8D 47 04 45 31 FF 41 56 41 BE 01 00 00 00 41 55 45 31 ED 41 54 55 53 48 89 4C 24 F0 48 89 44 24 D8 B8 01 00 00 00 48 89 74 24 F8 4C 89 44 24 E8 89 C3 44 89 4C 24 E4 0F B6 4F 02 D3 E3 89 D9 48 8B 5C 24 38 FF C9 89 4C 24 D4 0F B6 4F 01 D3 E0 48 8B 4C 24 F0 FF C8 89 44 24 D0 0F B6 07 C7 01 00 00 00 00 C7 44 24 C8 00 00 00 00 C7 44 24 C4 01 00 00 00 C7 44 24 C0 01 00 00 00 C7 44 24 BC 01 00 00 00 C7 03 00 00 00 00 89 44 24 CC 0F B6 4F 01 01 C1 B8 00 03 00 00 D3 E0 31 C9 8D B8 36 07 00 00 41 39 FF 73 13 48 8B 5C 24 D8 89 C8 FF C1 39 F9 66 C7 04 43 00 04 EB EB 48 8B 7C 24 F8 89 D0 45 31 D2 41 83 CB FF }
	condition:
		any of them
}
...
rule Nrv2x
{
	...
	strings: 
		...
		//old
		$a5 = { 8A 06 46 88 07 47 01 DB 75 07 8B 1E 83 EE FC 11 DB 72 ED B8 01 00 00 00 01 DB 75 07 8B 1E 83 EE FC 11 DB 11 C0 01 DB 77 EF 75 09 8B 1E 83 EE FC 11 DB 73 E4 31 C9 83 E8 03 72 67 C1 E0 08 8A 06 46 83 F0 FF 74 78 89 C5 01 DB 75 07 8B 1E 83 EE FC 11 DB 11 C9 01 DB 75 07 8B 1E 83 EE FC 11 DB 11 C9 75 20 41 01 DB 75 07 8B 1E 83 EE FC 11 DB 11 C9 01 DB 77 EF 75 09 8B 1E 83 EE FC 11 DB 73 E4 83 C1 02 3D 00 F3 FF FF 83 D1 01 8D 14 07 83 F8 FC 7E 14 8A 02 42 88 07 47 49 75 F7 E9 64 FF FF FF 89 E8 EB A2 90 90 8B 02 83 C2 04 89 07 83 C7 04 83 E9 04 77 F1 01 CF E9 48 FF FF FF 5E 2B 7F FC 57 8D BE 00 00 00 00 B9 26 00 00 00 8A 07 47 2C E8 3C 01 77 F7 80 3F 02 75 F2 8B 07 8A 5F 04 66 C1 E8 08 C1 C0 10 86 C4 29 F8 80 EB E8 01 F0 89 07 83 C7 05 89 D8 E2 D9 }
		//PE x64 and ELF 64
		$a4 = { 31 DB 31 C9 48 83 CD FF E8 50 00 00 00 01 DB 74 02 F3 C3 8B 1E 48 83 EE FC 11 DB 8A 16 F3 C3 48 8D 04 2F 83 F9 05 8A 10 76 21 48 83 FD FC 77 1B 83 E9 04 8B 10 48 83 C0 04 83 E9 04 89 17 48 8D 7F 04 73 EF 83 C1 04 8A 10 74 10 48 FF C0 88 17 83 E9 01 8A 10 48 8D 7F 01 75 F0 F3 C3 FC 41 5B ( 41 80 F8 08 74 0D E9 AC 00 00 00 | EB 08 ) 48 FF C6 88 17 48 FF C7 8A 16 01 DB 75 0A 8B 1E 48 83 EE FC 11 DB 8A 16 72 E6 8D 41 01 EB 07 FF C8 41 FF D3 11 C0 41 FF D3 11 C0 01 DB 75 0A 8B 1E 48 83 EE FC 11 DB 8A 16 73 E4 83 E8 03 72 1D C1 E0 08 0F B6 D2 09 D0 48 FF C6 83 F0 FF 0F 84 58 00 00 00 D1 F8 48 63 E8 72 38 EB 0E 01 DB 75 08 8B 1E 48 83 EE FC 11 DB 72 28 FF C1 01 DB 75 08 8B 1E 48 83 EE FC 11 DB 72 18 41 FF D3 11 C9 01 DB 75 08 8B 1E 48 83 EE FC 11 DB 73 ED 83 C1 02 EB 05 41 FF D3 11 C9 48 81 FD 00 FB FF FF 83 D1 02 E8 ?? FF FF FF E9 5C FF FF FF }
...
rule UPX_OEP_place
{
	...
	strings:
		...
		$a4 = { 75 F2 8B 07 8A 5F 04 66 C1 E8 08 C1 C0 10 86 C4 29 F8 80 EB E8 01 F0 89 07 83 C7 05 ?? D8 E2 D9 8D BE ?? ?? ?? ?? 8B 07 09 C0 74 3C 8B 5F 04 8D 84 30 ?? ?? ?? ?? 01 F3 50 83 C7 08 FF 96 ?? ?? ?? ?? 95 8A 07 47 08 C0 74 DC 89 F9 57 48 F2 AE 55 FF 96 ?? ?? ?? ?? 09 C0 74 07 89 03 83 C3 04 EB E1 FF 96 ?? ?? ?? ?? ?? E9 }
		//unknown ver
		$a13 = { 75 F2 8B 07 8A 5F 04 66 C1 E8 08 C1 C0 10 86 C4 29 F8 80 EB E8 01 F0 89 07 83 C7 05 ?? D8 E2 D9 8D BE ?? ?? ?? ?? 8B 07 09 C0 74 55 8B 5F 04 8D 84 30 ?? ?? ?? ?? 01 F3 50 83 C7 08 FF 96 ?? ?? ?? ?? 95 8A 07 47 08 C0 74 DC 89 F9 79 17 7A 0E 8B 07 83 C7 04 8B 84 30 ?? ?? ?? ?? EB 16 0F B7 07 47 50 47 B9 ?? ?? ?? ?? 55 FF 96 ?? ?? ?? ?? 09 C0 74 07 89 03 83 C3 04 EB C8 FF 96 ?? ?? ?? ?? 61 E9 }
		...
		//0.72
		$a19 = { 75 F2 8B 07 8A 5F 04 66 C1 E8 08 C1 C0 10 86 C4 29 F8 80 EB E8 01 F0 89 07 83 C7 05 89 D8 E2 D9 5F 8B 07 09 C0 74 3D 8B 5F 04 8D 84 30 ?? ?? ?? ?? 01 F3 50 83 C7 08 FF 96 ?? ?? ?? ?? 92 8A 07 47 08 C0 74 DC 52 89 F9 79 07 0F B7 07 47 50 47 B9 57 48 F2 AE 52 FF 96 ?? ?? ?? ?? 5A 89 03 83 C3 04 EB DA 8D 5E FC 83 C7 04 31 C0 8A 07 47 09 C0 74 22 3C EF 77 11 01 C3 8B 03 86 C4 C1 C0 10 86 C4 01 F0 89 03 EB E2 24 0F C1 E0 10 66 8B 07 83 C7 02 EB E2 61 E9 }

		//3.91
		$a14 = { 75 F2 8B 07 8A 5F 04 66 C1 E8 08 C1 C0 10 86 C4 29 F8 80 EB E8 01 F0 89 07 83 C7 05 ?? D8 E2 D9 8D BE ?? ?? ?? ?? 8B 07 09 C0 74 3C 8B 5F 04 8D 84 30 ?? ?? ?? ?? 01 F3 50 83 C7 08 FF 96 ?? ?? ?? ?? 95 8A 07 47 08 C0 74 DC 89 F9 57 48 F2 AE 55 FF 96 ?? ?? ?? ?? 09 C0 74 07 89 03 83 C3 04 EB E1 FF 96 ?? ?? ?? ?? 8B AE ?? ?? ?? ?? 8D BE 00 F0 FF FF BB 00 10 00 00 50 54 6A 04 53 57 FF D5 8D 87 1F 02 00 00 80 20 7F 80 60 28 7F 58 50 54 50 53 57 FF D5 58 61 8D 44 24 80 6A 00 39 C4 75 FA 83 EC 80 E9 }		
		$a15 = { 75 F2 8B 07 8A 5F 04 66 C1 E8 08 C1 C0 10 86 C4 29 F8 80 EB E8 01 F0 89 07 83 C7 05 ?? D8 E2 D9 8D BE ?? ?? ?? ?? 8B 07 09 C0 74 3C 8B 5F 04 8D 84 30 ?? ?? ?? ?? 01 F3 50 83 C7 08 FF 96 ?? ?? ?? ?? 95 8A 07 47 08 C0 74 DC 89 F9 57 48 F2 AE 55 FF 96 ?? ?? ?? ?? 09 C0 74 07 89 03 83 C3 04 EB E1 FF 96 ?? ?? ?? ?? 8B AE ?? ?? ?? ?? 8D BE 00 F0 FF FF BB 00 10 00 00 50 54 6A 04 53 57 FF D5 8D 87 9F 01 00 00 80 20 7F 80 60 28 7F 58 50 54 50 53 57 FF D5 58 8D 9E 00 F0 FF FF 8D BB ?? ?? ?? ?? 57 31 C0 AA 59 49 50 6A 01 53 FF D1 61 8D 44 24 80 6A 00 39 C4 75 FA 83 EC 80 E9 }
		//dll unknown ver
		...
		//x64 dll
		$a16 = { 74 5B 8B 5F 04 48 8D 8C 30 ?? ?? ?? ?? 48 01 F3 48 83 C7 08 FF 96 ?? ?? ?? ?? 48 95 8A 07 48 FF C7 08 C0 74 D7 79 0A 48 0F B7 17 48 83 C7 02 EB 0A 48 89 F9 48 89 FA FF C8 F2 AE 48 89 E9 FF 96 ?? ?? ?? ?? 48 09 C0 74 09 48 89 03 48 83 C3 08 EB CA 48 83 C4 28 5D 5F 5E 5B 31 C0 C3 48 83 C4 28 48 83 C7 04 48 8D 5E FC 31 C0 8A 07 48 FF C7 09 C0 74 23 3C EF 77 11 48 01 C3 48 8B 03 48 0F C8 48 01 F0 48 89 03 EB E0 24 0F C1 E0 10 66 8B 07 48 83 C7 02 EB E1 48 8B AE ?? ?? ?? ?? 48 8D BE ?? ?? ?? ?? BB ?? ?? ?? ?? 50 49 89 E1 41 B8 04 00 00 00 48 89 DA 48 89 F9 48 83 EC 20 FF D5 48 8D 87 ?? ?? ?? ?? 80 20 7F 80 60 28 7F 4C 8D 4C 24 20 4D 8B 01 48 89 DA 48 89 F9 FF D5 48 83 C4 28 5D 5F 5E 5B 48 8D 44 24 80 6A 00 48 39 C4 75 F9 48 83 EC 80 4C 8B 44 24 18 48 8B 54 24 10 48 8B 4C 24 08 E9 }
		//x64 exe
		$a17 = { 74 4A 8B 5F 04 48 8D 8C 30 ?? ?? ?? ?? 48 01 F3 48 83 C7 08 FF 96 ?? ?? ?? ?? 48 95 8A 07 48 FF C7 08 C0 74 D7 48 89 F9 48 89 FA FF C8 F2 AE 48 89 E9 FF 96 ?? ?? ?? ?? 48 09 C0 74 09 48 89 03 48 83 C3 08 EB D6 FF A6 ?? ?? ?? ?? 48 83 C4 28 48 8B AE ?? ?? ?? ?? 48 8D BE 00 F0 FF FF BB 00 10 00 00 50 49 89 E1 41 B8 04 00 00 00 48 89 DA 48 89 F9 48 83 EC 20 FF D5 48 8D 87 ?? ?? ?? ?? 80 20 7F 80 60 28 7F 4C 8D 4C 24 20 4D 8B 01 48 89 DA 48 89 F9 FF D5 48 83 C4 28 5D 5F 5E 5B 48 8D 44 24 80 6A 00 48 39 C4 75 F9 48 83 EC 80 E9 }
		//Linux oep.. kinda
		$a18 = { 5E 6A 02 5F 6A 01 58 0F 05 6A 7F 5F 6A 3C 58 0F 05 5B 6A 01 68 0C 00 40 00 50 68 FC 25 73 00 51 41 57 BF 00 00 C0 00 6A 07 5A BE FC 25 73 00 6A 32 41 5A 45 29 C0 6A 09 58 0F 05 39 C7 0F 85 ?? FE FF FF BE 00 00 40 00 89 FA 29 F2 74 15 01 D5 01 54 24 08 01 54 24 18 89 D9 29 F1 C1 E9 03 FC F3 48 A5 97 48 89 DE 50 92 AD 50 48 89 E1 AD 97 AD 44 0F B6 C0 48 87 FE FF D5 59 C3 }
	condition:
		any of them
}

rule UPX_Modified_Or_Inside
{
	meta:
		author="_pusher_"
		date = "2016-08"
		description = "UPX Signature likely wiped (was not found)"
	strings:
		$a0 = "UPX!" ascii nocase
	condition:
		(UPX_OEP_place) and 
		...
		(
		not ($a0 in (0x1E0..0x3E0)) or
		not ( (uint8(@a0+0x07) >= 0x01) and (uint8(@a0+0x07) <= 0x0A) ) 
		) //issus ?
		and not ($a0 at 0xB4)
		)
}
